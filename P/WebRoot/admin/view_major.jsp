...
<body>
	...
	<div class="template-page-wrapper">
			...
			<div class="templatemo-content">
				...
				<div class="col-md-12 col-sm-12">
					...
					<a href="javascript:;" class="btn btn-info" data-toggle="modal"
						data-target="#add_item">添加专业</a> <a href="javascript:;"
						class="btn btn-primary" data-toggle="modal"
						data-target="#import_item">导入专业</a> <a href="../major/exportExcel"
						class="btn btn-success">导出专业</a>
						...
						<tbody>
							...
							<c:if test="${!empty pg.list}">
								<c:forEach items="${pg.list}" var="item" varStatus="s">
									<tr
										onmouseover="updateItem('${item.id}','${item.majorName}','${item.majorCode}');">
					...
					<div class="pager clearfix text-center">
						<form name="pageForm" action="../major/view_major" method="POST">
							${pg.page.pageInfor}
						</form>
					</div>
		...
		<div class="modal fade" id="import_item" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form action="../major/importExcel" method="POST"
						...
						<div class="col-md-6 margin-bottom-15 cfg_add_input">
							<label for="exampleInputFile">选择专业数据导入文件</label> <input
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form action="addMajor" method="post">
						...
						<div class="col-md-6 margin-bottom-15 cfg_add_input">
							<label for="firstName" class="control-label">专业代码</label> <input
								type="text" class="form-control" id="item_majorCode_add"
								name="majorCode" placeholder="专业代码">
						</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form action="updateMajor" method="post">
						...
						<div class="col-md-6 margin-bottom-15 cfg_add_input">
							<label for="firstName" class="control-label">专业代码</label> <input
								type="text" class="form-control" id="item_majorCode_edit"
								name="majorCode" placeholder="专业代码">
						</div>
		...
		<div class="modal fade" id="del_item" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<form action="deleteMajor" method="post">
		...
		<script type="text/javascript">
			function updateItem(item_id, item_majorName, item_majorCode) {
				$("#item_id_del").val(item_id);

				$("#item_id_edit").val(item_id);
				$("#item_majorName_edit").val(item_majorName);
				$("#item_majorCode_edit").val(item_majorCode);
			}
		</script>
		<script type="text/javascript">
			//如果点击全选按钮
				...
				var checklist = document.getElementsByName("subBox");
					...
					if(total == 0){
						...
						if(!confirm("您是否要删除 "+total+" 条记录？")){
							...
							window.location.href="../major/deleteAllMajor?ids="+ids;
						}	
					}
				}
